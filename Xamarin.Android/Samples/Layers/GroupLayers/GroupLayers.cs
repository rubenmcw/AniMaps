...
namespace ArcGISRuntime //Xamarin.Samples.GroupLayers
{
    ...
    public class GroupLayers : Activity
    {
        ...
        private async void Initialize()
        {
            ...
            //FeatureLayer testLayer = new FeatureLayer(new Uri("https://services8.arcgis.com/LLNIdHmmdjO2qQ5q/arcgis/rest/services/TestAnimalLayer/FeatureServer"));
            ...
            //_mySceneView.Scene.OperationalLayers.Add(testLayer);
